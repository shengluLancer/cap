...
<div id="content">
    <form action="chooseMethodAction.do" method="get">
    	<fieldset>
    	<span class="graytitle">Select Fulfillment Type</span>
		<ul class="pageitem">
			<li class="button"><input name="pickup" id="pickup" type="submit" value="Pickup Now"/></li>
		</ul>
		<ul class="pageitem">
			<li class="button"><input name="getDelivered" id="getDelivered" type="submit" value="Get Delivered"/></li>
		</ul>
		</form>
		</fieldset>
	</form>
