...
<div id="content">
    <form action="getDeliverLocInitAction.do" method="get">
		...
		<ul class="pageitem">
			<li class="bigfield"><input type="text" id="address" name="address" readonly value="<%=request.getAttribute("address")==null? "Carnegie Mellon University" : request.getAttribute("address")%>"/></li>
		</ul>
